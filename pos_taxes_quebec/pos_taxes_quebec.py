...
##############################################################################
#    
# Module : pos_taxes_quebec
# Créé le : 2014-01-14 par ZEA Informatique Inc.
#
# Ajout de TPS et TVQ sur la facture dans Point of Sale
#
##############################################################################
import openerp
...
class inherit_pos_order_for_taxes_quebec(osv.osv):
    _name='pos.order'
    _inherit='pos.order'
...
inherit_pos_order_for_taxes_quebec()
