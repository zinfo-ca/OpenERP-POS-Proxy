function openerp_pos_quebec(instance, module){ //module is instance.point_;of_sale
    ...
    module.QuebecOrderWidget = module.OrderWidget.include({
...
//TPSTVQ E
    ...
    module.QuebecProductListWidget = module.ProductListWidget.include({
    ...
    module.QuebecPosWidget = module.PosWidget.include({
        template: 'PosWidget',
        close: function() {
    ...
    module.QuebecPaymentScreenWidget = module.PaymentScreenWidget.include({
...
openerp.point_of_sale = function(instance) {
    ...
    openerp_pos_quebec(instance,module);       // import openerp_pos_proxy_taxes_quebec
